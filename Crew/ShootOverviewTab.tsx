  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 animate-in fade-in duration-500">
      ...
      <div className="lg:col-span-8 space-y-8">
        <div className="bg-white/[0.01] border border-white/5 rounded-3xl p-8 lg:p-10">
          <h3 className="text-xl font-bold mb-10">Shoot Overview</h3>
        ...
        <div className="bg-white/[0.01] border border-white/5 rounded-3xl p-8">
            <h3 className="text-lg font-bold mb-4">Equipment Needed (0/0)</h3>
            <div className="h-24 flex items-center justify-center border-2 border-dashed border-white/5 rounded-2xl text-white/20 text-sm">
      ...
      <div className="lg:col-span-4 space-y-6">
        ...
        {/* VERTICAL STEPPER */}
        <div className="bg-[#E8D1AB]/[0.03] border border-[#E8D1AB]/10 rounded-3xl p-8">
        ...
        <div className="bg-white/[0.02] border border-white/5 rounded-3xl p-8 space-y-6">
          ...
          <div>
            ...
            <p className="text-base font-semibold text-white/90">Pre Production</p>
          </div>
...
function DetailItem({ label, value, icon }: any) {
  return (
    <div className="space-y-2">
      <p className="text-[11px] uppercase text-white/30 font-bold tracking-[0.15em]">{label}</p>
      <div className="flex items-start gap-3 text-[15px] font-semibold text-white/90 leading-tight">
