      ...
      <div className={`min-h-screen pb-30 p-4 lg:p-6 lg:px-10 lg:py-9 transition-colors duration-300 ${isDark ? "bg-transparent" : "bg-[#F3F4F6]"}`}>
        ...
        >
          ...
          <div className="flex gap-5 items-center">
            ...
            <Button
              className={`rounded-md border py-1 px-3.5 h-8 ${
                isDark ? "bg-[#1A1A19] border-[#252523]" : "bg-[#fff] border-[#E5E5E5]"
              }`}
            >
              <Pen size={14} />
              Edit
            ...
            <Button
              className={`rounded-md border p-1.5 w-8 h-8 ${
                isDark ? "border-[#252523]" : "bg-[#fff] border-[#E5E5E5]"
              }`}
            >
        ...
        <div className="flex flex-col gap-6 my-6">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
              {/* Search field */}
              <div
                className={`relative flex w-full items-center gap-1 rounded-xl border transition-all duration-300 ${
                  isDark ? "bg-[#202020] border-white/20" : "bg-[#fff] border-[#E5E5E5]"
                }`}
              >
                <Search
                ...
                <input
                  ...
                  className={`h-12 w-full min-w-0 pl-10 pr-4 rounded-xl text-xs lg:text-sm transition-all focus:outline-none focus:ring-1 ${
                    isDark
              ...
              <div className="flex items-center gap-2">
                <Button
                  className={`h-12 px-3 lg:px-5 transition-colors text-sm font-medium border rounded-lg lg:rounded-xl ${
                    isDark
            ...
            <div
              className={`flex flex-wrap items-center gap-3 p-4 rounded-2xl ${isDark ? "bg-[#121212] border border-white/5" : "bg-gray-100 border border-gray-200"}`}
            >
              <BasicDropdown
                label="CP"
                value={cpFilter}
