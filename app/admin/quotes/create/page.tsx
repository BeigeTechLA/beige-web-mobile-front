        ...
        <div className={`border rounded-[18px] mb-8 bg-[#171717] border-[#3D3D3D] ${view === 'selection' ? 'overflow-visible' : 'p-10 overflow-hidden'}`}>
          {view === 'logistics' ? (
            <div className="space-y-16">
              <section>
                <div className="mb-7">
                  <h2 className="text-xl font-medium leading-none mb-2 text-white">Logistics</h2>
            ...
            <div>
              ...
              <div className="bg-[#0F0F0F] border border-[#4A4A4A] rounded-[14px] p-5 relative overflow-hidden">
                <div className="flex justify-between items-center">
                  <div className="space-y-1">
                    <h3 className="text-[15px] font-medium text-white leading-none">Rush Delivery</h3>
                    <p className="text-[#F0DCB1] text-[13px] font-semibold tracking-tight leading-none">$1,500.00</p>
                  </div>
            ...
            <div>
              ...
              <div
                className={`w-full  p-5 rounded-2xl border transition-colors duration-300 flex items-center justify-between bg-[#0A0A0A] border-[#222222]`}
