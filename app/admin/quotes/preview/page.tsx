        ...
        <div className={`border rounded-[18px] mb-8 bg-[#171717] border-[#3D3D3D]`}>
          ...
          <div className="p-4 lg:p-9 space-y-3 lg:space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              {/* Right */}
              <div>
                <h2 className="text-2xl lg:text-4xl text-white font-bold">QUOTATION</h2>
                <div className="mt-2.5 text-xs lg:text-sm text-[#BDBDBD] text-right">
                  <p>Quote #: Q1</p>
            ...
            <div className="my-4 lg:my-9 border-t  border-[#FFFFFF5C]" />

            {/* Bill Addresses to */}
            <div className="space-y-2 lg:space-y-5">
              <p className="text-[#71717B] text-sm font-semibold mb-3 uppercase">Bill To</p>
            ...
            <div className="bg-[#FAFAFA] rounded-xl p-4 text-xs lg:text-sm space-y-1.5 mb-5 lg:mb-9">
            ...
            <div className="space-y-2 lg:space-y-4 mb-6 lg:mb-12">
              <p className="text-xs lg:text-sm text-[#71717B] font-semibold uppercase">Service Include</p>
              <div className="text-xs lg:text-sm grid grid-cols-5 text-[#FFF] font-medium border-b  border-[#FFFFFF5C] pb-2">
              ...
              <div className="text-sm lg:text-base grid grid-cols-5 text-[#FFFFFF99] font-medium">
            ...
            {logisticsData.length > 0 && (
              <div className="space-y-2 lg:space-y-4 mb-4 lg:mb-8">
                <p className="text-xs lg:text-sm text-[#71717B] font-semibold uppercase">Add-ons</p>
            ...
            {logisticsData.length > 0 && (
              <div className="space-y-2 lg:space-y-4 mb-4 lg:mb-8">
                <p className="text-xs lg:text-sm text-[#71717B] font-semibold uppercase">Logistics</p>
                <div className="space-y-2 lg:space-y-4">
                  {
            ...
            <div className="bg-[#E8D1AB] rounded-xl p-3 lg:p-6 space-y-3 lg:space-y-6">
              ...
              <div className="flex justify-between items-center text-lg text-white lg:text-xl bg-[#171717] p-2 lg:p-4 rounded-lg lg:rounded-xl font-bold">
                <p>Final Total</p>
            ...
            <div className="space-y-2 lg:space-y-3">
              <p className="text-xs lg:text-sm text-white font-semibold uppercase">Terms & Conditions</p>
              <ul className="text-xs lg:text-sm text-[#AAAAAA] list-disc list-inside">
            ...
            {/* Contact */}
            <div className="p-4 text-xs lg:text-sm text-white text-center">
