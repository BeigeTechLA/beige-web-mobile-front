          ...
          <div className="flex gap-2">
            ...
            {hasFormDetails ? (
              <Button
                ...
                className={`w-full h-14 rounded-md font-semibold text-sm flex items-center justify-center gap-2 transition-all ${isDark ? 'bg-[#111] text-[#E5D5B8] border border-white/10' : 'bg-[#F3F3F3] text-zinc-600 border border-[#E3E3E3]'}`}
              >
