...
export default function ClientDetailsPage() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-8 bg-black min-h-screen text-white" style={{ fontFamily: 'var(--font-instrument-sans)' }}>
        ...
        <div className="flex items-center gap-1 bg-[#111] p-1.5 rounded-xl w-fit border border-[#333]">
          <button
            ...
            className={`px-8 py-2.5 rounded-lg text-sm font-semibold transition-all ${
              activeTab === "Paid" ? "bg-[#E5D5B8] text-black shadow-lg" : "text-[#777] hover:text-white"
            }`}
          >
            Paid Shoots
          </button>
          <button
            ...
            className={`px-8 py-2.5 rounded-lg text-sm font-semibold transition-all ${
              activeTab === "Unpaid" ? "bg-[#E5D5B8] text-black shadow-lg" : "text-[#777] hover:text-white"
            }`}
          >
            Draft or Unpaid
          </button>
                    ...
                    <tbody>
                        {filteredShoots.length > 0 ? filteredShoots.map((item: any) => (
                            ...
                            >
                                ...
                                <td className="py-6 px-6">
                                    <span className={`text-[11px] font-bold px-5 py-2 rounded-full uppercase tracking-tight ${
                                        activeTab === "Paid" 
