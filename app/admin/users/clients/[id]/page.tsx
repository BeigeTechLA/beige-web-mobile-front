...
export default function ClientDetailsPage() {
    ...
    return (
        <>
            ...
            <div className={`overflow-hidden min-h-screen p-4 lg:p-6 lg:px-10 lg:py-9 max-w-7xl mx-auto space-y-8 ${isDark ? "bg-black text-white" : "bg-[#F4F5F7] text-black"}`} style={{ fontFamily: 'var(--font-instrument-sans)' }}>
                ...
                <div className="space-y-6 pt-4">
                    ...
                    {/* Tab Selection */}
                    <div className={`flex items-center gap-1 p-1.5 rounded-xl w-fit border ${isDark ? "bg-[#111] border-[#333]" : "bg-gray-100 border-gray-200"}`}>
                        <button
                            onClick={() => setActiveTab("Paid")}
                            className={`px-8 py-2.5 rounded-lg text-sm font-semibold transition-all ${activeTab === "Paid" ? (isDark ? "bg-[#E5D5B8] text-black shadow-lg" : "bg-white text-black shadow-sm") : (isDark ? "text-[#777] hover:text-white" : "text-gray-500 hover:text-black")}`}
                        >
                            Paid Shoots
                        </button>
                        <button
                            onClick={() => setActiveTab("Unpaid")}
                            className={`px-8 py-2.5 rounded-lg text-sm font-semibold transition-all ${activeTab === "Unpaid" ? (isDark ? "bg-[#E5D5B8] text-black shadow-lg" : "bg-white text-black shadow-sm") : (isDark ? "text-[#777] hover:text-white" : "text-gray-500 hover:text-black")}`}
                        >
                            Draft or Unpaid
                        </button>
                    </div>
