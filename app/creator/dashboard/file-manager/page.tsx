          ...
          <div className="flex w-full flex-nowrap items-center gap-1.5 overflow-x-auto rounded-xl bg-[#171717] p-1.5 no-scrollbar scroll-smooth lg:w-fit lg:gap-3">
            {tabs.map((tab) => (
              <Button
                ...
                className={`flex h-10 shrink-0 items-center gap-2 whitespace-nowrap rounded-lg px-4 py-2 text-sm font-medium transition-all lg:h-12 lg:px-6 ${selectedTab === tab.name
                ...
                {isOpen && (
                  <div className="absolute right-0 top-full z-[50] mt-2 w-48 overflow-hidden rounded-xl border border-white/10 bg-[#171717] shadow-2xl">
                    <button
                      ...
                      className={`w-full px-4 py-3 text-left text-sm transition-colors ${viewMode === "grid" ? "bg-white/10 text-white" : "text-white/60 hover:bg-white/5"
                        }`}
                    >
                      Grid View
                    </button>
                    <button
                      ...
                      className={`w-full px-4 py-3 text-left text-sm transition-colors ${viewMode === "list" ? "bg-white/10 text-white" : "text-white/60 hover:bg-white/5"
                        }`}
                    >
                      List View
                    </button>
