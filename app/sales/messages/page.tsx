...
import { Search, Plus, MoreVertical, Send, Smile, UserPlus, Calendar, Check, CheckCheck, ArrowUpToLine } from "lucide-react";
...
export default function SalesMessagesPage() {
    ...
    return (
        <>
            <Topbar pathname={pathname}
                actions={
                    <>
                        ...
                        <Button onClick={() => console.log("Create Meeting")} className="bg-[#E5D5B8] text-black h-12 px-4 lg:px-7">
                            Book a Shoot
                        </Button>
                    </>
                }
            ...
            <div className="overflow-hidden p-4 lg:p-6 lg:px-10 lg:py-9 flex flex-col h-[calc(100vh-120px)] overflow-hidden">
                        ...
                        <div className="px-8 py-5 border-b border-zinc-900 flex items-center justify-between bg-[#0D0D0D]">
                            <div className="flex items-center gap-4">
                                <div className="relative">
                                    <div className="w-11 h-11 rounded-full overflow-hidden shrink-0 mt-1 border border-zinc-800">
                                        <Image src={activeChat?.avatar || "/images/avatar.png"} alt="Sales" width={44} height={44} className="object-cover" />
                                    </div>
                                    <span className="absolute bottom-0.5 right-0.5 w-2.5 h-2.5 bg-green-500 rounded-full ring-2 ring-[#0D0D0D]"></span>
                                </div>
                                <div className="space-y-0.5">
                                    <h3 className="font-bold text-white text-base">Sales Team</h3>
                        ...
                        <div className="flex-1 overflow-y-auto px-8 py-6 space-y-8 custom-scrollbar relative bg-[#0D0D0D]">
                            ...
                            <div className="flex justify-center">
                                <span className="text-zinc-600 text-[11px] italic bg-zinc-900/40 px-5 py-2 rounded-full border border-zinc-800/30">
                                    Sales Team Started The Conversation
                                </span>
                            </div>
                            ...
                            {/* Message: Sales Team (Right) */}
                            <div className="flex flex-col items-end gap-1">
                                <div className="flex items-start gap-3 max-w-[65%] flex-row-reverse">
                                    <div className="w-9 h-9 rounded-full overflow-hidden shrink-0 mt-1 border border-zinc-800">
                                        <Image src="/images/avatar.png" alt="Sales" width={36} height={36} />
                                    </div>
                                    <div className="space-y-1.5">
                                        <div className="bg-[#1A1A1A] p-4 rounded-[18px] rounded-br-none border border-zinc-800/60 shadow-sm text-right">
                                            <span className="text-[10px] text-zinc-500 uppercase block mb-1.5">~ Sales</span>
                                            <p className="text-[13px] text-zinc-300 leading-relaxed font-medium">
                                                Yes, Drone Shots are Confirmed. They will be included in Final Deliverables
                                            </p>
                                        </div>
                                    </div>
                                </div>
