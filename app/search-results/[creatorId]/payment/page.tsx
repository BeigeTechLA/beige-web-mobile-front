            ...
            <div className="text-center mb-8 lg:mb-12">
              ...
              >
                ...
                <p className="text-white/70 mx-auto text-xs lg:text-base">
                  Review your booking details and complete your payment to
                  secure your session
                </p>
              </motion.div>
            </div>
                    ...
                    {creator && (
                      <div className="flex items-center gap-2 lg:gap-4 border-b border-black/20 pb-3 lg:pb-5 px-3 lg:px-5">
                        ...
                        <div className="flex justify-between items-start w-full">
                          <div>
                            <h4 className="font-medium text-base lg:text-2xl">
                              {creator.name}
                            </h4>
                          ...
                          <div className="flex items-center gap-1 text-xs lg:text-sm">
                            ...
                            <span>
                              {creator.rating} ({creator.reviews_count})
                            </span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="bg-[#E2FFD3] border-[0.5px] border-[#389903] rounded-xl p-3 lg:p-5 flex gap-2 mx-5 justify-start">
                      ...
                      <div>
                        ...
                        <p className="text-xs lg:text-sm text-[#212122] leading-relaxed">
                          Your payment is protected with Stripe's secure
                          encryption. Funds are only released when you're
                          satisfied.
                        </p>
                      </div>
                    </div>
