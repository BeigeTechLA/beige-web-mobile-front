      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-12">
          ...
          >
            ...
            <div className="relative w-full max-w-[700px] aspect-[616/485.914] flex items-center justify-center">
              
              {/* Back Image (Left Offset - Purple Car scene) */}
              <div className="absolute top-0 left-0 w-[65%] aspect-[486/466.918] rounded-2xl overflow-hidden opacity-60 z-0 border border-white/5">
                <img 
                  src="/images/crew/CREW(1).png" 
                  alt="Production scene background" 
                  className="w-full h-full object-cover" 
                />
              </div>

              {/* Front Main Image (Running scene) - Placed in middle z-index stack to allow middle image to tuck behind its right edge */}
              <div className="absolute top-[10%] left-[8%] aspect-[616/485.91] rounded-2xl overflow-hidden z-10 shadow-2xl shadow-black/50 border border-white/10">
                <img 
              ...
              <div className="absolute bottom-0 right-[2%] w-[65%] aspect-[486/466.918] rounded-2xl overflow-hidden opacity-80 z-0 border border-white/5">
                <img 
                  src="/images/crew/CREW(2).png" 
                  alt="Production scene secondary" 
                  className="w-full h-full object-cover" 
                />
              </div>
          ...
          {/* Right Column: Text Section (Slides in from the right) */}
          <motion.div 
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, margin: "-10% 0px" }}
