            ...
            <div className="w-full max-w-[600px] bg-black border border-zinc-800 rounded-[24px] p-8 shadow-2xl relative">
                ...
                <div className="space-y-8">
                    <div className="relative">
                        {/* Visual Label hack to match design 'Select Assigned CP' cutting the border? 
                    Or just a standard floating label. 
                    The design shows 'Select Assigned CP' text inside.
                */}
                        <button
