...
export default function RecentActivity() {
  ...
  return (
    <div className={`w-full rounded-2xl md:h-[392px] flex flex-col overflow-hidden border transition-all duration-300 ${
      isDark ? "bg-[#171717] text-white border-[#3D3D3D]" : "bg-white text-[#000000] border-[#E5E5E5]"
    }`}>
      {/* Header (fixed) */}
      <div className={`flex justify-between items-center p-5 shrink-0 border-b transition-colors duration-300 ${
        isDark ? "bg-[#101010] border-[#3D3D3D]" : "bg-[#FFFCF6] border-[#E5E5E5]"
      }`}>
        ...
        <button className={`flex items-center gap-2 px-4 py-2 rounded-full text-xs transition-colors border ${
          isDark 
