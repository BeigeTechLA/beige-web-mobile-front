...
import { DollarSign, Clock, Shield, PieChart } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
...
export default function CPCompensationOverview() {
  const { theme } = useTheme();
  const isDark = theme === "dark";
  const [activeMetricId, setActiveMetricId] = useState("total");
  const [rangeValue, setRangeValue] = useState("Month");
  ...
  const metrics = [
    {
      ...
      value: "$69,500",
      helperText: "Awaiting payout processing",
      icon: DollarSign,
    },
    {
      id: "pending",
    ...
    },
    {
      ...
      value: "265",
      helperText: "Pending balance due",
      icon: PieChart,
    },
  ];
    ...
    >
      <div className="flex justify-between items-center mb-5 gap-4">
        ...
        <Select value={rangeValue} onValueChange={setRangeValue}>
          ...
          >
            {["Month", "Last 30 Days", "This Quarter", "This Year"].map((option) => (
