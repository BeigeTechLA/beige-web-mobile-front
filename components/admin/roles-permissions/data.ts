...
export const basePermissions: PermissionMatrixRow[] = [
  ...
  },
  {
    ...
    moduleKey: "client_affiliate_overview",
    label: "Client Affiliate Overview",
    selected: false,
    allowedActions: ["view"],
    access: { view: false, create: false, edit: false, delete: false },
  },
  ...
  {
    id: "book-a-shoot",
    moduleKey: "client_book_a_shoot",
    label: "Client Book A Shoot",
    selected: false,
  ...
  },
  {
    ...
    moduleKey: "admin_sales_representative",
    label: "Admin Sales Representative",
    selected: false,
    allowedActions: ["view", "create", "edit", "delete"],
    access: { view: false, create: false, edit: false, delete: false },
  },
