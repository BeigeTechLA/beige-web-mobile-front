...
const toCompactLocation = (rawLocation?: string | null) => {
        ...
        if (response && response.data) {
          ...
          const mappedUsers = data.map((member: any) => {
            ...
            return {
              ...
              location: toCompactLocation(member.location),
              role: displayRole,
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className={`text-sm font-medium border-b cursor-pointer leading-none tracking-normal ${isDark ? "text-[#888] border-[#333]" : "bg-[#FFFCF6] text-[#000] border-[#E5E5E5]"}`}>
                ...
                <th className="py-5 px-6 font-medium">Creative</th>
                    ...
                    <td className="py-5 px-6">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className={`${isDark ? "text-[#7A7A7A]" : "text-[#6B6B6B]"} text-xs mt-0.5`}>{user.email}</p>
                      ...
                      <div className="p-4 space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="text-right">
                            ...
                            <p className={`text-xs ${isDark ? "text-[#A1A1A1]" : "text-gray-700"}`}>{user.location}</p>
                          </div>
                        </div>
