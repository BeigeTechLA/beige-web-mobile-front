...
export default function AffiliateFileManager() {
  ...
  const renderViewToggle = () => (
    <>
      ...
      <div className="hidden md:flex flex-wrap items-center bg-[#202020] rounded-lg w-full md:w-fit border border-white/5">
        <Button
      ...
      <div className="space-y-8">
        ...
        <div className="pb-20 lg:pb-0">
          ...
          {filteredPhaseCards.length > 0 ? (
            viewMode === "list" ? (
              <div>
                <div className="hidden lg:block overflow-x-auto rounded-xl border border-white/10 bg-[#111111]">
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="bg-[#202020] text-[#E8D1AB] text-sm font-normal">
                        <th className="py-4 px-6 font-medium">Name</th>
                        <th className="py-4 px-6 font-medium">Type</th>
                        <th className="py-4 px-6 font-medium">Files</th>
                    ...
                    <tbody>
                      {filteredPhaseCards.map((phase) => (
                        <tr
                          key={phase.id}
                          className="cursor-pointer border-t border-white/5 hover:bg-white/[0.02] transition-colors"
                          onClick={() => {
                        ...
                        >
                          ...
                          <td className="py-4 px-6 text-white/80">Phase</td>
                          <td className="py-4 px-6 text-white">
                            {String(phase.fileCount).padStart(2, "0")}
                          </td>
                          <td className="py-4 px-6 text-white/80">
                            Updated{" "}
                            {formatRelativeTime(
                              (phase.id === "pre"
                                ? preFolder?.lastOpened
                                : postFolder?.lastOpened) || selectedWorkspace.lastOpened
                            )}
                          </td>
                ...
                <div className="space-y-3 lg:hidden">
                  {filteredPhaseCards.map((phase) => (
                    <button
                      ...
                      className="w-full rounded-xl border border-white/10 bg-[#171717] p-4 text-left"
                    >
                      <div className="flex items-center justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          <p className="mt-1 text-xs text-white/50">
                            {String(phase.fileCount).padStart(2, "0")} Files
                          </p>
                        </div>
                        <ExternalLink className="shrink-0 text-white/40" size={16} />
                      </div>
                    </button>
                  ))}
                </div>
        ...
        {viewMode === "list" ? (
          <div>
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody>
                  {filteredFolders.map((folder) => (
                    <tr
                      key={`folder-${selectedPath}-${folder.name}`}
                      className="cursor-pointer border-t border-white/5 hover:bg-white/[0.02] transition-colors"
                      onClick={() => {
                    ...
                    >
                      ...
                      <td className="py-4 px-6 text-white/80">Folder</td>
                      <td className="py-4 px-6 text-white">
                        {String(folder.fileCount).padStart(2, "0")}
                      </td>
                      <td className="py-4 px-6 text-white/80">
                        Updated {formatRelativeTime(folder.lastOpened)}
                      </td>
                      <td className="py-4 px-6 text-right">
                        <ExternalLink className="inline-block text-white/40" size={16} />
                      </td>
                    ...
                    >
                      <td className="py-4 px-6 text-white">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm font-semibold">{file.title}</span>
                        </div>
                      </td>
                      <td className="py-4 px-6 text-white/80">{file.contentType || "File"}</td>
                      <td className="py-4 px-6 text-white">01</td>
                      <td className="py-4 px-6 text-white/80">
                        Updated {formatRelativeTime(file.lastOpened)}
                      </td>
                      <td className="py-4 px-6 text-right">
                        <button
                          type="button"
            ...
            <div className="space-y-3 lg:hidden">
              {filteredFolders.map((folder) => (
                <button
                  key={`folder-mobile-${selectedPath}-${folder.name}`}
                  type="button"
                  onClick={() => {
                    const nextPath = [selectedPath, folder.name].filter(Boolean).join("/");
                    setSelectedPath(nextPath);
                ...
                >
                  <div className="flex items-center justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 text-xs text-white/50">
                        {String(folder.fileCount).padStart(2, "0")} Files
                      </p>
                    </div>
                    <ExternalLink className="shrink-0 text-white/40" size={16} />
                  </div>
