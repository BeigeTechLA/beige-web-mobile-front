...
import AffiliateStartConversationModal from "@/components/affiliate/AffiliateStartConversationModal";
import AffiliateManageParticipantsModal from "@/components/affiliate/AffiliateManageParticipantsModal";
...
export default function AffiliateMessages() {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-120px)] overflow-hidden">
            ...
            <AffiliateStartConversationModal
                isOpen={showStartModal}
                onClose={() => setShowStartModal(false)}
            />
            <AffiliateManageParticipantsModal
