...
export default function AffiliateOverviewChart({ externalSelectedDate }: { externalSelectedDate?: Date | null }) {
  ...
  return (
    <div className="bg-[#171717] border border-[#3D3D3D] rounded-lg lg:rounded-2xl p-5 w-full text-white mt-4 lg:mt-9">
      {/* Header */}
      ...
      {/* Metric Cards Grid */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 lg:mb-10 bg-[#101010] rounded-lg lg:rounded-2xl p-4">
        {metrics.map((m: any) => {
