...
type AffiliateProjectTimelineProps = {
  status?: number;
...
export default function AffiliateProjectTimeline({ status = 0, postProduction, revisionVersions }: AffiliateProjectTimelineProps) {
  ...
  useEffect(() => {
    console.log("[AffiliateProjectTimeline] received timeline sub-items", {
      postProduction,
      revisionVersions,
    });
