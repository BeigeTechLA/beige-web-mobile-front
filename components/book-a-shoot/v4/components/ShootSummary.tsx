  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 md:px-8 py-6 lg:py-5 2xl:py-6 flex flex-col min-h-[calc(100vh-160px)] justify-between">
      ...
      <div className="flex flex-col gap-4">
        ...
        {/* <div className="w-full rounded-lg lg:rounded-2xl border border-white/20 bg-gradient-to-b from-[#191919] to-rgba(16,16,16,0) p-4 lg:p-5 2xl:p-7">
          <div className="flex items-center justify-between">
            <h2 className="text-sm lg:text-xl 2xl:text-[26px] font-['Roboto_Condensed'] font-bold text-white">
              Studios
            </h2>
            <button
              type="button"
          ...
          <hr className="border-t border-white/20 my-4 2xl:my-7" />
        ...
        <div className="w-full rounded-lg lg:rounded-2xl border border-white/20 bg-gradient-to-b from-[#191919] to-rgba(16,16,16,0) p-4 lg:p-5 2xl:p-7">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 pt-1">
            ...
            <div className="w-full lg:w-fit px-4 lg:px-7 py-2 lg:py-4 text-center rounded-full bg-white text-[#101010] font-medium text-sm lg:text-base 2xl:text-lg italic">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          {/* Add-ons Subcard */}
          <div className="w-full lg:w-1/3 rounded-lg lg:rounded-2xl border border-white/20 bg-gradient-to-b from-[#191919] to-rgba(16,16,16,0) p-4 lg:p-5 2xl:p-7 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between">
                <h2 className="text-sm lg:text-xl 2xl:text-[26px] font-['Roboto_Condensed'] font-bold text-white">
                  Add-ons
          ...
          <div className="w-full lg:w-2/3 rounded-lg lg:rounded-2xl border border-white/20 bg-gradient-to-b from-[#191919] to-rgba(16,16,16,0) p-4 lg:p-5 2xl:p-7">
            <h2 className="text-sm lg:text-xl 2xl:text-[26px] font-['Roboto_Condensed'] font-bold text-white">
              Included Services
            </h2>
            <hr className="border-t border-white/20 my-4 2xl:my-7" />
      ...
      <div className="mb-5 2xl:mb-8">
        <h2 className="text-base lg:text-lg 2xl:text-[26px] font-['Roboto_Condensed'] font-bold text-white mb-5 lg:mb-7 2xl:mb-10">
          Contact Information
        </h2>
