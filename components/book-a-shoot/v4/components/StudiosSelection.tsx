  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 md:px-8 py-6 flex flex-col min-h-[calc(100vh-160px)] justify-between select-none">
      ...
      <div>
        ...
        {viewMode === "stack" ? (
          <div className="relative w-full max-w-6xl mx-auto flex items-center justify-center my-3 lg:my-6">
            ...
            <div className="w-full max-w-6xl overflow-hidden px-1 lg:px-10">
              ...
              >
                {studios.map((studio) => {
                  ...
                  return (
                    <SwiperSlide key={studio.id} className="border border-white/20 bg-[#101010] max-h-[386px] lg:max-h-none h-[386px] lg:h-[450px]">
                      <div className="w-full h-full flex flex-col md:flex-row items-stretch">
                        ...
                        <div className="flex-1 flex flex-col justify-between rounded-r-xl bg-gradient-to-b from-[#191919] to-rgba(16,16,16,0) p-3.5 lg:p-5">
                          <div>
                            {/* Title & Status Badge */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-5 my-6">
            {studios.map((studio) => {
              ...
              return (
                <div
                  key={studio.id}
                  className="rounded-lg lg:rounded-2xl border bg-gradient-to-b from-[#191919] to-rgba(16,16,16,0) border border-white/20 p-4 flex flex-col justify-between"
                >
                  <div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className={`px-4 lg:px-5 py-2 rounded-full text-xs lg:text-lg font-medium cursor-pointer ${isAdded
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-[#E8D1AB] text-2xl lg:text-2xl">
