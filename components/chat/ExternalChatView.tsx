                        ...
                        {role === "admin" && (
                          <div className="mt-6 flex justify-center">
                            <button
                              ...
                              className={`inline-flex items-center gap-2 rounded-xl px-5 py-3 text-sm font-semibold transition-colors disabled:cursor-not-allowed disabled:opacity-50 ${isDark
