...
export default function EarningsBreakdownModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-end bg-[#101010CC] font-sans backdrop-blur-sm animate-in fade-in duration-200 p-0">
      ...
      <div
        className={`relative h-full w-full lg:max-w-2xl flex flex-col border rounded-lg lg:rounded-r-none lg:rounded-l-2xl overflow-y-auto animate-in slide-in-from-right duration-200 ${
          isDark
      ...
      >
        ...
        <div className="flex items-start justify-between p-4 lg:p-9">
          <div>
            ...
            <p
              className={`text-xs lg:text-base mt-0.5 ${isDark ? "text-white/50" : "text-black/50"}`}
            >
          ...
          <button
            onClick={onClose}
            className={`p-3 lg:p-4 rounded-full transition-colors border cursor-pointer ${
              isDark
        ...
        <hr
          className={`border-t ${isDark ? "border-[#CACACA]" : "border-black/10"}`}
        />
        ...
        <div className="p-4 lg:p-9">
          <div className="space-y-4 lg:space-y-6">
            ...
            <div className="space-y-3 lg:space-y-4 ">
              <h3
                className={`text-base lg:text-xl font-semibold capitalize ${isDark ? "text-white" : "text-black"}`}
              >
                Shoot Information
              </h3>
              <div
                className={`rounded-lg p-4 space-y-3 lg:space-y-4 ${isDark ? "bg-[#1F1F1F]" : "bg-black/[0.02] border border-black/5"}`}
              >
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <p
                      className={`text-xs lg:text-sm ${isDark ? "text-[#6B6864]" : "text-black/40"}`}
                    >
                      Shoot Name
                    </p>
                    <p
                      className={`text-sm lg:text-base font-semibold mt-0.5 ${isDark ? "text-white" : "text-black"}`}
                    >
                      {data.shootName}
                    </p>
                  </div>
                  <div>
                    ...
                    <p
                      className={`text-sm lg:text-base font-medium mt-0.5 ${isDark ? "text-white" : "text-black"}`}
                    >
                      {data.clientName}
                    </p>
                  </div>
                ...
                <hr
                  className={`border-t ${isDark ? "border-white/40" : "border-black/10"}`}
                />

                <div
                  className={`flex flex-wrap gap-x-4 lg:gap-x-8 gap-y-2 text-xs lg:text-sm ${isDark ? "text-white" : "text-black/80"}`}
                >
                  <div className="flex items-center gap-1.5">
                    <Calendar
                      size={14}
                      className={isDark ? "text-[#6B6864]" : "text-black/40"}
                    />
                    <span>{data.date}</span>
                  </div>
                  <div className="flex items-center gap-1.5">
            ...
            <div className="space-y-3 lg:space-y-4 ">
              ...
              <div
                className={`space-y-3 lg:space-y-4 rounded-lg p-4 text-sm lg:text-base ${isDark ? "bg-[#1F1F1F]" : "bg-black/[0.02] border border-black/5"}`}
              >
                <div className="flex justify-between items-center">
                  <span className={isDark ? "text-white/50" : "text-black/50"}>
                    Base Shoot Compensation
                  </span>
                  <span
                ...
                <div className="flex justify-between items-center pt-1">
                  <span className={isDark ? "text-zinc-300" : "text-black/70"}>
                    Total Compensation
                  </span>
            ...
            <div className="space-y-3 lg:space-y-4 ">
              ...
              <div className="grid grid-cols-1 gap-3 lg:gap-4">
                ...
                <div
                  className={`rounded-lg p-3 lg:p-6 flex flex-col gap-2 border ${
                    isDark
                ...
                >
                  <div className="flex justify-between items-center">
                    <p
                      className={`text-xs lg:text-sm font-medium ${isDark ? "text-[#10B981]" : "text-[#137333]"}`}
                    >
                      Payment Received
                    </p>
                    <p
                      className={`text-lg lg:text-2xl font-bold mt-2 tracking-tight ${isDark ? "text-[#10B981]" : "text-[#137333]"}`}
                    >
                      {formatCurrency(data.advance.amount)}
                    </p>
                  </div>
                  <p
                    className={`text-xs ${isDark ? "text-white" : "text-black/70"}`}
                  >
                ...
                <div
                  className={`rounded-xl p-3 lg:p-6 flex flex-col gap-2 border ${
                    isDark
                ...
                >
                  <div className="flex justify-between items-center">
                    <p
                      className={`text-xs lg:text-sm font-medium ${isDark ? "text-[#F66054]" : "text-[#C5221F]"}`}
                    >
                      Remaining Balance
                    </p>
                    <p
                      className={`text-lg lg:text-2xl font-bold mt-2 tracking-tight ${isDark ? "text-[#F66054]" : "text-[#C5221F]"}`}
                    >
              ...
              <div className="space-y-3 lg:space-y-4">
                ...
                <div className="rounded-lg bg-[#1F1F1F] divide-y divide-white/10 overflow-hidden">
                  {paymentReceipts.map((receipt) => (
                    <div
                      key={receipt.id}
                      className="flex items-center justify-between gap-3 p-3 lg:p-4"
                    >
                      <div className="min-w-0">
                        <div className="flex flex-wrap items-center gap-x-2 gap-y-1">
                          ...
                          <span className="text-sm font-bold text-[#E8D1AB]">
                            {receipt.amount}
                          </span>
                        </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-xs lg:text-sm">
                <span className={isDark ? "text-white/60" : "text-black/50"}>
                  Payment Progress
                </span>
                <span
                  className={`font-medium ${isDark ? "text-white" : "text-black"}`}
                >
                  {data.paymentProgress}% Paid
                </span>
              </div>
              <div
                className={`w-full h-2.5 rounded-full overflow-hidden ${isDark ? "bg-[#1F1F1F]" : "bg-black/10"}`}
              >
                <div
              ...
              <div className="flex justify-between items-center text-xs pt-0.5">
                <span
                  className={`font-medium ${isDark ? "text-[#10B981]" : "text-[#137333]"}`}
                >
                  {formatCurrency(data.advance.amount)} paid
                </span>
                <span
                  className={`font-medium ${isDark ? "text-[#F66054]" : "text-[#C5221F]"}`}
                >
