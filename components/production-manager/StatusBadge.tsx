type Status = "Booked" | "Cancelled" | "In-Progress" | "Initiated" | "PreProduction" | "Shoot Day" | "PostProduction" | "Revision" | "Completed" | "Assets Delivered" | "Paid" | "Unknown";
...
export const StatusBadge = ({ status, mobile }: { status: Status; mobile?: boolean }) => {
    const styles = {
        ...
        "Shoot Day": "bg-[#FFF4C9] text-[#BA6605] border-[#FFF4C9]",
        ...
        "Assets Delivered": "bg-[#ECFDF3] text-[#16A34A] border-[#BBF7D0]",
