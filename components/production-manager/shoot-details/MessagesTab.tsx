...
export default function MessagesTab() {
    const [hasMessages, setHasMessages] = useState(true); // Toggle between empty and active chat
    ...
    if (!hasMessages) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[600px] py-20">
                ...
                <CreateChatModal isOpen={isCreateChatOpen} onClose={() => setIsCreateChatOpen(false)} />
            </div>
        );
    }
        ...
        <>
            <div className="bg-[#111111] border border-[#222222] rounded-2xl overflow-hidden h-[700px] flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                    ...
                    {/* System Message */}
                    <div className="flex justify-center">
                        <span className="text-[#666666] text-sm italic">Admin Started The Conversation</span>
                    </div>
                    ...
                    <div className="flex justify-end gap-3">
                        <div className="max-w-md">
                            <div className="bg-[#1A1A1A] border border-[#333333] rounded-2xl rounded-tr-none p-4">
                                <div className="text-[#888888] text-xs mb-1">~ Admin</div>
