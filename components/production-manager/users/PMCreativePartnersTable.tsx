...
import { ChevronRight, Search, ChevronDown, Check, X, AlertCircle } from "lucide-react";
...
export const PMCreativePartnersTable = () => {
    ...
    }, [currentPage, limit, debouncedSearch, statusFilter, skillsMap]);

    const handleRowClick = (id: string, e: React.MouseEvent) => {
        if ((e.target as HTMLElement).closest('button')) return;
        const cleanId = id.replace('#', '');
        router.push(`/production-manager/creative-partners/${cleanId}`);
    };
