...
export default function EditSalesBookingDetailsForm({ leadId, initialBookingData, onSuccess, onCancel, isModal, hideCreativeSelector, projectId, isDark = true }: EditSalesBookingDetailsFormProps) {
