    ...
    return (
      <textarea
        ...
        className={cn(
          ...
          // "dark:border-white/10 dark:bg-black dark:text-white dark:placeholder:text-[#FFFFFF4D]",
          ...
          // 1. BASE LAYOUT (No colors here)
          "flex w-full min-h-[120px] rounded-md px-3 py-2 text-base md:text-sm transition-all duration-200",
          "border-[1.5px] focus:outline-none focus:ring-0",
          "disabled:cursor-not-allowed disabled:opacity-60",
